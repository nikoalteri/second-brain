...
2. The lookup table currently contains `Transferm` in the live database for ID `3`, while the seeder source lists `Transfer`. This summary records the live value because that is what the form will render today.
