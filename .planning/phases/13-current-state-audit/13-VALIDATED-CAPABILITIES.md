...
| Credit cards expose REST list/show/create/update/delete plus cycle, issue, payment, and expense routes, and SPA list/detail/create/edit routes. | structural-only | code | `routes/api.php`, `resources/js/router/index.js` |
