...
class AdminPanelScopingTest extends TestCase
{
    ...
    public function test_panel_user_cannot_open_another_users_account_record(): void
    {
        ...
        $this->actingAs($this->withPanelMfa($userA))->get("/hub/accounts/{$ownAccount->id}/edit")->assertOk();
        $this->actingAs($this->withPanelMfa($userA))->get("/hub/accounts/{$foreignAccount->id}/edit")->assertNotFound();
    }
    ...
    public function test_panel_user_cannot_open_another_users_notification_record(): void
    {
        ...
        $this->actingAs($this->withPanelMfa($userA))->get("/hub/notifications/{$ownNotification->id}/edit")->assertOk();
        $this->actingAs($this->withPanelMfa($userA))->get("/hub/notifications/{$foreignNotification->id}/edit")->assertNotFound();
    }
    ...
    public function test_panel_user_cannot_open_another_users_user_setting_record(): void
    {
        ...
        $this->actingAs($this->withPanelMfa($userA))->get("/hub/user-settings/{$ownSetting->id}/edit")->assertOk();
        $this->actingAs($this->withPanelMfa($userA))->get("/hub/user-settings/{$foreignSetting->id}/edit")->assertNotFound();
    }
    ...
    public function test_superadmin_can_open_another_users_account_record(): void
    {
        ...
        $this->actingAs($this->withPanelMfa($admin))->get("/hub/accounts/{$foreignAccount->id}/edit")->assertOk();
    }
}
