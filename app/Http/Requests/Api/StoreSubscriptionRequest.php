...
class StoreSubscriptionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'account_id'              => ['nullable', 'integer', OwnedByAuthenticatedUser::accounts(), 'required_without:credit_card_id'],
            'credit_card_id'          => ['nullable', 'integer', OwnedByAuthenticatedUser::creditCards(), 'required_without:account_id'],
            ...
            'category_id'             => ['nullable', 'integer', OwnedByAuthenticatedUser::categories()],
